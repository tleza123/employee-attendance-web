 ...
 * 
 * วิธีใช้งาน:
 * 1. วางโค้ดทั้งหมดนี้ลงในไฟล์ Code.gs ของ Apps Script
 * 2. เลือกฟังก์ชัน "setupAttendanceBackend" แล้วกดปุ่ม "เรียกใช้ (Run)" เพื่อสร้างตารางทั้งหมดใน Google Sheets
 * 3. กด "การทำให้ใช้งานได้ (Deploy) > การทำให้ใช้งานได้รายการใหม่ > เว็บแอป" แล้วใช้งานได้ทันที!
 * (ไม่ต้องสร้างไฟล์ Index.html เพิ่มเติมอีกต่อไป)
 * 
...
function doGet(e) {
  ...
  try {
    ...
    // หากไม่มีไฟล์ Index ให้ใช้ HTML ที่ฝังมาในตัวไฟล์นี้อัตโนมัติทันที
